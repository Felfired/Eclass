<?php 
    ...
    {   
        $id =$_GET['id'];
        $sql = "SELECT * FROM student WHERE Login='$id'";
                            ...
                            <main>
                                <div class="container-fluid">
                                    ...
                                    <ol class="breadcrumb mb-2">
                                        ...
                                        <li class="breadcrumb-item"> <a href="admin_stprefs.php"> Ρυθμίσεις Χρηστών </a> </li>  
                                        <li class="breadcrumb-item active"> Επεξεργασία Στοιχείων Φοιτητή </li>
                                    </ol>
                                    <!--Dynamic Student Container-->
                                    <div id="dynamic-centered-row-1">
                                        <div class="container">
                                            <div class="row justify-content-center">
                                                <div class="col-lg-6">
                                                                ...
                                                                <div class="form-row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input class="form-control py-3" id="inputPassword" type="password" placeholder="" name="inputPassword" data-toggle="tooltip" data-placement="top" title="Password should be at least 8 characters long."/>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label class="small mb-1" for="inputrePassword"> Επανάληψη Κωδικού </label>
                                                                            <input class="form-control py-3" id="inputrePassword" type="password" placeholder="" name="inputrePassword"/>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group mt-4 mb-0">
                                                                    ...
                                                                    <?php 
                                                                        if(isset($_POST['submit'])){
                                                                            ...
                                                                            $sql =  "UPDATE student SET Name = '$name' , Surname = '$surname', Year = $year WHERE Login = '$id'";
                                                                            $sql1 = "UPDATE user SET Passwd = '$hash' WHERE Login = '$id'";
                                                    ...
                                                    <div class="card-footer text-center">
                                                        <div class="small">
                                                            <a href="admin_stprefs.php"> Επιστροφή </a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
