                        ...
                        <div id="layoutSidenav_content">
                            <main>
                                <div class="container-fluid">
                                    <h3 class="mt-4"> Οριστικοποίηση Βαθμολογίας </h3>
                                    <ol class="breadcrumb mb-2">
                                        ...
                                        <li class="breadcrumb-item active"> Οριστικοποίηση Βαθμολογίας </li>
                                    </ol>
                                            ...
                                            <div class="col-xl-9">
                                                <div class="card shadow-lg border-0 rounded-lg mt-3 mb-5">
                                                    <div class="card-header">
                                                        <h3 class="text-center font-weight-normal my-2"> Οριστικοποίηση Βαθμολογίας </h3>
                                                    </div>
                                                    <div class="card-body">
                                                            ...
                                                            <div class="form-row justify-content-center">
                                                                <div class="col-lg-10">
                                                                    <div class="form-group">
                                                                        <label class="med mb-1" for="LessonName"> Είστε σίγουρος/η ότι θέλετε να καταθέσετε την τελική βαθμολογία για το συγκεκριμένο μάθημα; </label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-row justify-content-center">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <input type="submit" class="btn btn-primary btn-block" name = "submit" value="Συνέχεια">
                                                                            <?php
                                                                                ...
                                                                                {   
                                                                                    $sql = "UPDATE student_Exams SET isFinal = 1 WHERE ID_Course = '$ID_Course'";
