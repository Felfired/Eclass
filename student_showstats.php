                                                    ...
                                                    <div class="card-footer small text-muted">Updated <?php echo date("h:i:sa") ?> </div>
                                                                    <?php
                                                                        if(isset($_POST['submit']))
                                                                        {
                                                                            ...
                                                                            $counter = 0;
                                                                            $array = array();
                                                                            $sql = "SELECT ID FROM teaching WHERE Year = $year AND Semester = $semester";
                                                                            $result = mysqli_query($conn , $sql);
                                                                            while($ID_Course =  mysqli_fetch_array($result)){
                                                                                $ID = $ID_Course['ID'];
                                                                                $sql1 = "SELECT Grade FROM student_exams WHERE ID_Course = '$ID' AND ID_Student = '$ID_Student'";
                                                                                $result1 = mysqli_query($conn , $sql1);
                                                                                $Grade = mysqli_fetch_assoc($result1)['Grade'];
                                                                                if($Grade>=5){
                                                                                    $success = $success +1;
                                                                                    $counter = $counter +1;
                                                                                }
