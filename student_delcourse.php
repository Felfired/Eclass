                        ...
                        <div id="layoutSidenav_content">
                            <main>
                                <div class="container-fluid">
                                    <h3 class="mt-4"> Απεγγραφή Μαθήματος </h3>
                                    <ol class="breadcrumb mb-2">
                                        <li class="breadcrumb-item"> <a href="student.php"> Αρχική Σελίδα </a> </li>
                                        <li class="breadcrumb-item"> <a href="student_courses.php"> Μαθήματα </a> </li> 
                                        <li class="breadcrumb-item active"> Απεγγραφή Μαθήματος </li>
                                    </ol>
                                            ...
                                            <div class="col-xl-9">
                                                <div class="card shadow-lg border-0 rounded-lg mt-3 mb-5">
                                                    <div class="card-header">
                                                        <h3 class="text-center font-weight-normal my-2"> Απεγγραφή </h3>
                                                    </div>
                                                    <div class="card-body">
                                                            ...
                                                            <div class="form-row justify-content-center">
                                                                <div class="col-lg-10">
                                                                    <div class="form-group">
                                                                        <label class="med mb-1" for="LessonName"> Είστε σίγουροι οτι θέλετε να απεγγραφείτε απο το επιλεγμένο μάθημα; </label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-row justify-content-center">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <input type="submit" class="btn btn-primary btn-block" name = "submit" value="Συνέχεια">
                                                                            <?php
                                                                                ...
                                                                                {   
                                                                                    $sql = "DELETE FROM student_course WHERE ID_Student = '$ID_Student' AND ID_Course = '$ID_Course'";
                                                                                    mysqli_query($conn , $sql);
                                                                                    echo '<script type="text/javascript">';
                                                                                    echo 'window.location.href="student_courses.php"';
                                                                                    echo '</script>';
                                                                                }                                                                               
                                                                            ?>
                                                                    </div>
