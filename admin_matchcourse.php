                        ...
                        <div id="layoutSidenav_content">
                            <main>
                                <div class="container-fluid">
                                    <h3 class="mt-4 mb-3"> Αντιστοίχιση Mαθήματος </h1>
                                    <ol class="breadcrumb mb-2">
                                        ...
                                        <li class="breadcrumb-item active"> Αντιστοίχιση Mαθήματος </li>
                                    </ol>
                                            ...
                                            <div class="col-xl-9">
                                                <div class="card shadow-lg border-0 rounded-lg mt-3 mb-5">
                                                    <div class="card-header">
                                                        <h3 class="text-center font-weight-normal my-2"> Ανάθεση Μαθήματος </h3>
                                                    </div>
                                                    <div class="card-body">
                                                        <form id="student_form" method="post">
                                                            <div class="form-row justify-content-center">
                                                                <div class="col-lg-10">
                                                                    <div class="form-group">
                                                                        <label class="med mb-1" for="LessonName"> Επιλέξτε έναν καθηγητή για την ανάθεση του μαθήματος. </label>
                                                                        <select class="form-control" name = "match">
                                                                            <?php
                                                                                ...
                                                                                {
                                                                                    echo '<option value="'. $row1['Name'] . '">' . $row1['Name'] . ' ' . $row1['Surname'] . ' ' . '<' . $row1['Spec'] . '>' . '</option>';
                                                                                }
                                                                            ?>
                                                                        </select>
                                                                    </div>
                                                            ...
                                                            <div class="form-row justify-content-center">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        <input type="submit" class="btn btn-primary btn-block" name = "assignment" value="Ανάθεση">
                                                                            <?php
                                                                                if(isset($_POST['assignment']))
                                                                                {
                                                                                    ...
                                                                                    {
                                                                                        $Name=$_POST['match']; 
                                                                                        $query1 = "SELECT Login FROM professor WHERE Name = '$Name'";
                                                                                        $result1 = mysqli_query($conn, $query1);
                                                                                        $ID_Professor = mysqli_fetch_assoc($result1)["Login"];
                                                                                        $ID_Course =$_GET['id'];
                                                                                        $delete = "DELETE FROM professor_course WHERE ID_Course = '$ID_Course'";
                                                                                        mysqli_query($conn, $delete);
                                                                                        $Match = "INSERT INTO professor_course (ID_Course , ID_Professor)
                                                                                        VALUES('$ID_Course','$ID_Professor')";
                                                                                        mysqli_query($conn, $Match);
